    ...
    public partial class InicioProyecto : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, false, new DateTime(2024, 10, 8, 16, 22, 17, 170, DateTimeKind.Local).AddTicks(9299), 0, 21m, 3000m },
                    { 2, 2, false, new DateTime(2024, 10, 8, 16, 22, 17, 170, DateTimeKind.Local).AddTicks(9318), 1, 10m, 5000m },
                    { 3, 3, false, new DateTime(2024, 10, 8, 16, 22, 17, 170, DateTimeKind.Local).AddTicks(9320), 2, 21m, 8000m },
                    { 4, 4, false, new DateTime(2024, 10, 8, 16, 22, 17, 170, DateTimeKind.Local).AddTicks(9323), 3, 0m, 10000m }
                });
